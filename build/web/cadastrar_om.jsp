        ...
        <table class="table table-striped">
            ...
            <% for (OM om : lista) { %>
                <tr>
                    ...
                    <td><%= om.getStatus() %></td>
                    <td>
                        <a href="OMServlet?acao=editar&id=<%= om.getId() %>" class="btn btn-warning btn-sm">Editar</a>
                        <a href="OMServlet?acao=excluir&id=<%= om.getId() %>" class="btn btn-danger btn-sm">Excluir</a>
                    </td>
                </tr>
            <% } %>
            </tbody>
